...
```sh
ng add masterthesis-angular-calendar
```
...
```bash
npm install --save masterthesis-angular-calendar date-fns
```
...
import { CalendarModule, DateAdapter } from 'masterthesis-angular-calendar';
import { adapterFactory } from 'masterthesis-angular-calendar/date-adapters/date-fns';
