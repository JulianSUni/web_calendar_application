...
describe('masterthesis-angular-calendar schematics', () => {
  const projectName = 'masterthesis-angular-calendar-app';
  ...
  beforeEach(async () => {
    ...
    runner = new SchematicTestRunner(
      'masterthesis-angular-calendar-schematics',
      collectionPath
    );
    packageJsonPath = '/package.json';
  });

  it('should add masterthesis-angular-calendar to dependencies', async () => {
    const { name, version } = {
  ...
  it('should import masterthesis-angular-calendar module to root module', async () => {
  ...
  it('should import masterthesis-angular-calendar module to root module when passed as an option', async () => {
    const rootModulePath = `/projects/${projectName}/src/app/app.module.ts`;
    tree = await runner
      .runSchematicAsync(
        'ng-add',
        {
          ...defaultOptions,
          module: 'projects/app/app.full-calendar.module.ts',
        },
        appTree
      )
      .toPromise();
  ...
  it('should add masterthesis-angular-calendar css to architect builder', async () => {
    tree = await runner
      .runSchematicAsync('ng-add', defaultOptions, appTree)
      .toPromise();
